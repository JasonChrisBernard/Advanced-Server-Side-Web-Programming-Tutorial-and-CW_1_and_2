...
exports.saveProfile = (req, res) => {
  ...
  try {
    ...
    const programme = sanitizeSingleLineText(req.body.programme, 140);
    const graduationDate = String(req.body.graduationDate || "").trim();
    const industrySector = sanitizeSingleLineText(req.body.industrySector, 120);
