...
- stores programme, graduation date, and industry sector for CW2 staff filtering and graphs
...
- stores client-specific scope lists such as `read:alumni`, `read:analytics`, and `read:alumni_of_day`
...
- alumni profile filters by programme, graduation date, and industry sector
