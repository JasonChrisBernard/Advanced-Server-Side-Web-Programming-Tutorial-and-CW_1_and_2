...
$requestHost = !empty($_SERVER['HTTP_HOST']) ? $_SERVER['HTTP_HOST'] : 'localhost:8081';
$requestPort = !empty($_SERVER['SERVER_PORT']) ? (string) $_SERVER['SERVER_PORT'] : '';
$isCw1Portal = ($requestPort === '8080' || strpos($requestHost, ':8080') !== FALSE);
$config['base_url'] = $requestProtocol . '://' . $requestHost . '/';
...
|
*/
$config['encryption_key'] = 'ar_alumni_secret_key_change_this_123456789';
...
$config['sess_cookie_name'] = $isCw1Portal ? 'aralumni_cw1_session' : 'aralumni_cw2_session';
...
$config['api_allowed_origins'] = array(
	'http://localhost:8080',
	'http://localhost:8081',
	'http://127.0.0.1:8080',
	'http://127.0.0.1:8081'
...
$config['csrf_cookie_name'] = $isCw1Portal ? 'csrf_cw1_cookie' : 'csrf_cw2_cookie';
