    ...
    <div class="col-md-5">
        <div class="card shadow-sm mb-3">
            <div class="card-body">
                ...
                <p><strong>Selected Feature Date:</strong> <?php echo html_escape($featureDate); ?></p>
                <p><strong>Monthly Wins:</strong> <?php echo (int) $monthlyWinCount; ?> / 3</p>

                <div class="alert alert-info">
                    <strong>Status:</strong> <?php echo html_escape($blindStatus); ?>
                </div>

                <?php if ($dateAlreadySelected): ?>
                    <div class="alert alert-warning">
                        Winner selection has already been completed for this date.
                    </div>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <?php if ($todayFeatured): ?>
                    <p><strong><?php echo html_escape($todayFeatured['full_name']); ?></strong></p>
                    <p class="text-muted"><?php echo html_escape($todayFeatured['headline'] ?: 'No headline added'); ?></p>
                    <a class="btn btn-sm btn-outline-primary" href="<?php echo site_url('featured-today'); ?>">
                        View Featured Profile
                    </a>
                <?php else: ?>
                    <p class="text-muted mb-0">No featured alumnus selected for today yet.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
