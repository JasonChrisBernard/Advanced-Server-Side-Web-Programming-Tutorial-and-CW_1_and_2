...
An Express, EJS, SQLite, and Nodemailer coursework project for alumni registration, secure authentication, alumni profile management, blind bidding, and a bearer-token-protected developer API.
...
- `GET /api/v1/featured-alumnus/today`
